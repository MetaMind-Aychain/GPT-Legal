...
# 使用American-alpaca-plus-7b-merged模型在law_data.json数据集上finetune
experiment_name="American-alpaca-plus-7b-law-e1"

# 单卡或者模型并行
python finetune.py \
    --base_model "minlik/American-alpaca-plus-7b-merged" \
