...
if __name__ == '__main__':
    ...
    parser.add_argument('--load_path', default='../src/models/base_model/American_llama_7b/tokenizer_American.model', type=str)
    parser.add_argument('--save_dir', default='../src/models/base_model/save_American', type=str)
